...
<div class="page-header">
  <h1>About Us</h1>
    ...
    <p>This was a project started by Aaron Wisner and Matan Silver. The entire site is coded from scratch in HTML, PHP, CSS, and mySQL. We even host our own web-server. Aaron is in charge of the back-end functionality, and both Aaron and Matan share responsibility for the front-end. Currently, this site is in beta, so we are far from complete in development. We will will add a lot more. Expect weird visual formatting, and perhaps occasional functionality problems; these will get worked out as time progresses.</p>
